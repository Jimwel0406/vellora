...
REF = "public/hero-collection.jpg"
OUT = "public/hero-collection.jpg"
PROMPT = (
    "remove the second coffee cup from this image completely, keep only one ceramic coffee mug, "
    "keep everything else exactly the same: the same laptop, the same leather notebook with pen, "
    "the same wireless headphones, the same single ceramic mug, the same small green succulent pot, "
    "same cream linen background, same lighting, same layout, same wide composition. Photorealistic, high detail"
)
ASPECT = "3:2"
TRIES = 4
