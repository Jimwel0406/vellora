...
PROMPT = (
    "remove the green eucalyptus branch and any flowers or green plant from this image completely, "
    "keep everything else exactly the same: the same kraft shopping bag, the same soy candle in glass jar "
    "with wooden lid, the same rolled linen cloth, the same amber skincare bottle, same cream background, "
    "same lighting, same layout, same square centered composition. Photorealistic, high detail"
)
TRIES = 4
ASPECT = "1:1"
