...
// Generic keyword CSV ingestion. Copies into any project.
// Drop CSVs (Google Keyword Planner / Ahrefs Free export) into ./seo-keywords/
// and run. Produces seo-keywords/compiled.json with intent classification.
// Configurable keywords override: SEO_BRAND=YourBrand (navigational intent).
...
const BRAND = process.env.SEO_BRAND || "yourbrand";
...
const NAVIGATIONAL = [BRAND, "login", "track order", "store", "vendor", "contact"];
