...
export function FooterEcommerce() {
  return (
    <footer data-section="home-footer" className="section-home-footer bg-[#FAF7EF] border-t border-clay/10">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 pt-14 lg:pt-16 pb-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.25fr_1fr_1.25fr_1.5fr] gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-terracotta mt-3">
              Shop more, live better
            </p>
            <p className="text-sm text-clay/60 leading-relaxed mt-4 max-w-xs">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-clay">
              Quick Links
            </h4>
            <ul className="mt-5 space-y-3">
              {QUICK_LINKS.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-sm text-clay/60 hover:text-terracotta transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <p className="text-sm text-clay/60 leading-relaxed mt-5">
            ...
            <div className="mt-5 space-y-3">
              ...
              >
                ...
                <span>
                  <span className="block text-[9px] uppercase tracking-widest text-clay/50">
                    Download on the
                  </span>
                  <span className="block text-sm font-bold text-clay">App Store</span>
                </span>
              </a>
              <a
                href="#"
              ...
              >
                ...
                <span>
                  ...
                  <span className="block text-sm font-bold text-clay">Google Play</span>
                </span>
              </a>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-clay/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] uppercase tracking-[0.2em] font-bold text-clay/50">
